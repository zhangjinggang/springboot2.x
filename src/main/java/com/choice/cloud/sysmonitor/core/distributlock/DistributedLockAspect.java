...
@Aspect
@Component
@Order(AdviceOrder.DIST_LOCK)
public class DistributedLockAspect {

    @Autowired
    private DistributedLockTemplate lockTemplate;

    @Pointcut("@annotation(com.choice.cloud.sysmonitor.core.distributlock.DistributedLock)")
    ...
    public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
        ...
        //执行切入点方法
        return execute(pjp, method, lockName);
    }
    ...
    public String getLockName(Method method, Object[] args) {
        ...
        if (StringUtils.isBlank(lockName)) {
            throw new BusinessException(ResponseCodeEnum.NOT_FIND_LOCK_KEY);
        }
        return lockName;
     ...
     * @return
     */
    public Object execute(ProceedingJoinPoint pjp, Method method, final String lockName) {
        DistributedLock annotation = method.getAnnotation(DistributedLock.class);
    ...
    public Object lock(ProceedingJoinPoint pjp, DistributedLock annotation, final String lockName, boolean fairLock) {
        return lockTemplate.lock(new DistributedLockCallback<Object>() {
            ...
            @Override
            public Object fail() {
                throw new BusinessException(annotation.notLockRes());
            }
        }, fairLock);
    }
